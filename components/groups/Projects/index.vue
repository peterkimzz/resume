  ...
  <vue-title-container
    ...
    <div>
      <vue-definition
        ...
        <vue-tags :data="creaction"/>
      </vue-definition>
      <vue-definition
        block
        sub-title="2019년 8월 - 2019년 8월"
        title="고팀장"
      ...
      <vue-definition
        ...
        <vue-tags :data="contactyoutuber"/>
      </vue-definition>
      <vue-definition
        block
        sub-title="2019년 7월 - 2019년 7월"
        title="럭키스캐너"
        src="/imgs/luckyscanner_logo.png">
        <div>
          "MCN 전문 소프트웨어 개발사"
        </div>
        <vue-tags :data="luckyscanner"/>
      </vue-definition>
      <vue-definition
        block
        sub-title="2019년 6월 - 2019년 7월"
      ...
      <vue-definition
        ...
        <div>
          ...
          직접 참여했던 프로젝트는 총 3개입니다.<br>
          - www.gangmom.kr<br>
          - api.gangmom.kr<br>
          - admin.gangmom.kr<br><br>
        </div>
        <vue-tags :data="gangmom"/>
      </vue-definition>
      <vue-definition
        block
        sub-title="2017년 6월 - 2018년 6월"
        title="Factoryhunt"
        ...
        <div>
          ...
          이 프로젝트는 앱 보다는 반응형 웹사이트가 메인 타겟에게 익숙할 것으로 예상되어서 웹사이트로 개발했습니다.
        </div>
        <vue-tags :data="zerobase.factoryhunt"/>
      </vue-definition>
      <vue-definition
        block
        sub-title="2017년 4월 - 2017년 6월"
        title="Picon"
        ...
        <vue-tags :data="zerobase.picon"/>
      </vue-definition>
      <vue-definition
        block
        sub-title="2017년 2월 - 2017년 4월"
        title="Hoopee"
      ...
      <vue-definition
        ...
        <vue-tags :data="inactive.aManLikeFox"/>
      </vue-definition>
    </div>
  </vue-title-container>
</template>
